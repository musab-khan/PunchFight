...
public class MoveLetters : MonoBehaviour
{
    ...
    void MoveLetter()
    {
        ...
        LeanTween.moveX(rect, pointEnd.localPosition.x, duration).setOnComplete(() =>
        {
...
//              activeTiles.Peek().gameObject.transform.GetChild(1).GetComponent<ParticleSystem>().Play();
                ...
                popEffect.transform.localPosition = activeTiles.Peek().gameObject.transform.localPosition;
                popEffect.Play();
