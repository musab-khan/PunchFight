...
#region Properties
        ...
        public void Initialize()
        {
            ...
            if (!m_ShootScript) { Debug.LogError("Cannot find 'ShootSpherecast' component."); return; }
            ...
            m_Ragdoll.OnHit = () =>
            {
                ...
                ProjectileBase.DestroyProjectile(m_ShootScript.m_CurrentProjectile);
...
#region Unity Methods
        ...
        void LateUpdate()
        {
            ...
            if (Input.GetButtonDown ("Idle"))
            {
                    ...
                    m_Move = Vector3.zero;
                    BallProjectile.DestroyProjectile(m_ShootScript .m_CurrentProjectile);
            }
