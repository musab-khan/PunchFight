...
{
    /// <summary>
    /// Example using unity standard asset ThirdPersonCharacter ( renamed to ThirdPersonCharacterUnity )
    /// </summary>
    ...
    public class RagdollUserUnityTPC : MonoBehaviour, IRagdollUser
    {
        ...
        private ThirdPersonCharacterUnity m_UnityCharacter;
        ...
        public void Initialize()
        {
            ...
            m_UnityCharacter = GetComponent<ThirdPersonCharacterUnity>();
