    ...
    public class RagdollManagerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (ragdollWizard)
            {
                ...
                builder.currentObject = ragMan.gameObject;
                ...
                builder.OnWizardCreateCallback = () =>
                {
                    ...
                    RagdollManager.AddBodyColliderScripts(ragMan, builder.physicsMaterial );
            ...
            if (removeRagdoll)
            {
                if (ragMan.RagdollBones.Length > 0 &&
                    ragMan.RagdollBones.Length <= (int)BodyParts.BODY_PART_COUNT)
                {
                ...
                {
                    Debug.LogError("ragdoll bones length is outside bounds");
                }
            }
